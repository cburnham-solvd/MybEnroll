...
!function (a) {
    ...
    b.prototype = {
        constructor: b, dimension: function () {
            ...
            var b = this.dimension(), c = a.camelCase(["scroll", b].join("-")),
                d = this.$parent && this.$parent.find(".in"), e;
    ...
    "use strict", b.prototype = {
        constructor: b, refresh: function () {
            ...
            var a = this.$scrollElement.scrollTop() + this.options.offset, b = this.offsets, c = this.targets,
                d = this.activeTarget, e;
